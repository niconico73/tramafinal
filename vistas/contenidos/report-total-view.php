...
<div class="full-box page-header">
    ...
    <p class="text-justify">
        En el mÃ³dulo REPORTES podrÃ¡ ver, generar e imprimir reportes de ventas en formato PDF.
    </p>
</div>

<div class="container-fluid">
    <div id="today-sales">
        <h4 class="text-center">EstadÃ­sticas de ventas de hoy (<?php echo date("d-m-Y"); ?>)</h4>
        <div class="table-responsive">
            <table class="table table-bordered table-dashboard">
                ...
                <tbody>
                    ...
                    <?php }else{ ?>
                    <tr class="text-center">
                        <td colspan="4">NO HAY VENTAS REALIZADAS EL DÃA DE HOY</td>
                    </tr>
                    <?php
                        }
                ...
                <div class="row justify-content-md-center">
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="fecha_inicio" >Fecha inicial (dÃ­a/mes/aÃ±o)</label>
                            <input type="date" class="form-control" name="fecha_inicio" id="fecha_inicio" maxlength="30">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="fecha_final" >Fecha final (dÃ­a/mes/aÃ±o)</label>
...
<script>
    function generar_reporte(){
        Swal.fire({
			title: 'Â¿Quieres generar el reporte?',
			text: "La generaciÃ³n del reporte PDF puede tardar unos minutos para completarse",
			type: 'question',
