...
<?php } ?>
 ...
 <!-- Modal DETALLES -->
 <div class="modal fade" id="ModalEditDetallePago" tabindex="-1" role="dialog" aria-labelledby="ModalEditDetallePago" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalEditDetallePago">Agregar Detalle de Pago</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" id="detallePagoFormContainer">
        </div> 
