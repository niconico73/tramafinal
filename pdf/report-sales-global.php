<?php
	...
	if($error_fechas==""){
		...
		$pdf->Cell(45,8,iconv("UTF-8", "ISO-8859-1",'Ventas realizadas'),1,0,'C',true);
		$pdf->Cell(45,8,iconv("UTF-8", "ISO-8859-1",'Total en ventas'),1,0,'C',true);
		$pdf->Cell(46,8,iconv("UTF-8", "ISO-8859-1",'Costo de ventas'),1,0,'C',true);
		$pdf->Cell(45,8,iconv("UTF-8", "ISO-8859-1",'Ganancias'),1,0,'C',true);
        ...
        if($check_ventas->rowCount()>=1){
            ...
            $pdf->Cell(45,7,iconv("UTF-8", "ISO-8859-1",$ventas_totales),'LB',0,'C');
            $pdf->Cell(45,7,iconv("UTF-8", "ISO-8859-1",MONEDA_SIMBOLO.number_format($total_ventas,MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE),'LB',0,'C');
            $pdf->Cell(46,7,iconv("UTF-8", "ISO-8859-1",MONEDA_SIMBOLO.number_format($total_costos,MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE),'LB',0,'C');
            $pdf->Cell(45,7,iconv("UTF-8", "ISO-8859-1",MONEDA_SIMBOLO.number_format($total_utilidades,MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE),'LRB',0,'C');
        }else{
