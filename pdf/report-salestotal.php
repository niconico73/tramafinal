<?php
    ...
    if($error_fechas==""){
        ...
        $pdf->MultiCell(0,9,iconv("UTF-8", "ISO-8859-1",strtoupper("Reporte de totales ".$fecha_inicio." a ".$fecha_final)),0,'C',false);
        ...
        $pdf->Cell(90,8,iconv("UTF-8", "ISO-8859-1",'Producto'),1,0,'C',true);
        $pdf->Cell(90,8,iconv("UTF-8", "ISO-8859-1",'Cantidad vendida'),1,0,'C',true);
        ...
        if($consulta_ventas->rowCount() >= 1){
            ...
            foreach($datos_ventas as $ventas){
                $pdf->Cell(90,7,iconv("UTF-8", "ISO-8859-1",$ventas['producto_nombre']),'LB',0,'C');
                $pdf->Cell(90,7,iconv("UTF-8", "ISO-8859-1",$ventas['cantidad_vendida']),'LBR',0,'C');
                $pdf->Ln();
            }
        }else{
